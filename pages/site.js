...
function preparerSaut() {
  ...
  scene.innerHTML =
    `<span class="poisson">${FORMES.poisson}</span>` +
    `<span class="ecume ecume-depart">${FORMES.ecume}</span>` +
