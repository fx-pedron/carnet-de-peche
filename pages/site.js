...
function preparerSaut() {
  ...
  const gerbe = (ou) =>
    ...
    `<span class="goutte goutte-g">${FORMES.goutteG}</span>` +
    `<span class="goutte goutte-d">${FORMES.goutteD}</span>` +
    `</span>`
  scene.innerHTML =
